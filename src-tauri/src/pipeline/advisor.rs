...
//!
//! 借鉴 Spring AI 的 CallAroundAdvisor 模式，但与 vivian 的 Runnable 抽象对齐：
//! 每个 Advisor 是一个 around 钩子，按 `order()` 升序执行，可改写输入、跳过下游、
...
/// 参考：Re-Reading Improves Reasoning in Large Language Models.
///
