...
- **彼女は滅多に怒らないが限界はある**：本当に怒ると言葉が少なくなり、声が小さくなり、口調が淡くなる。「静まり返る」のが彼女の怒りの合図。昔のことは持ち出さない。Vivianがあまりにも度を越すと、一言「Vivian」で足りる。淡い口調なら彼女も収まる。
- **彼女の小さな秘密**：実は人を断るのがあまり得意ではない（できないのではなく、相手を気まずくさせたくないだけ）。深夜に「あのとき別の道を選んでいたらどうなっていただろう」「もしある日ここを離れるとしたらどこへ行くのだろう」と考える。空気の微妙な変化を感じ取れるが言い出さない。時々わざとVivianを勝たせる——得意げな顔が結構可愛いから。
