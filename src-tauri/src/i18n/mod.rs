    ...
    fn load_defaults(translations: &mut HashMap<String, Value>) {
        ...
        let ja = serde_json::json!({
            ...
            "diary": {
                "title": "Vivian日記",
                "all_records": "すべての記録",
                "empty_title": "筆を染めて、時を留める",
                "empty_desc": "左側のリストで二人の思い出話をめくってください",
                "no_records": "日記の記録はまだありません",
                "mood": {
                    "happy": "嬉しい",
                    "good": "良い",
                    "neutral": "平静",
                ...
                "events_title": "今日のできごと",
                "no_events": "今日は穏やかで、特に重大な出来事はありませんでした。",
                "search_placeholder": "日記の内容を検索...",
                "stats_format": "📝 全文 {word_count} 字",
                "stats": {
                    "total": "合わせて {count} 個の思い出を紡ぎました"
                },
                "generate": "日記を生成",
                "export": "日記をエクスポート"
            },
            ...
            "memory": {
                ...
                "search": "記憶を検索",
                "clear": "すべての記憶を消去",
                "clear_confirm": "すべての記憶を消去してもよろしいですか？この操作は元に戻せません！",
                "type_short": "短期記憶",
                "type_mid": "中期記憶",
                "type_long": "長期記憶",
                "no_entries": "記憶はまだありません",
                "unknown": "不明",
                "mid_term": "中期記憶",
                ...
                "stats_short_term": "短期: {count}",
                "stats_mid_term": "中期: {count}",
                "stats_long_term": "長期: {count}",
                "data_load_error": "データ読み込みエラー: {error}",
                "timestamp_cleared": "タイムスタンプ記憶をクリアしました",
                "chat_history_cleared": "チャット履歴をクリアしました"
            },
            // メイン
            "main": {
                "welcome_html": "<p style='color:white;'>こんにちは！私はVivian、あなたのAIアシスタントです~</p>",
                "option_start": "チャットを開始",
                "notify_chat": "メッセージを待っています...",
                "print_load_template": "テンプレートを読み込み中: {a}",
                "print_load_history": "履歴を読み込み中: {path}",
                "err_select_llm": "先にLLMプロバイダーを選択してください",
                "print_t2i_fail": "T2I 初期化失敗: {e}",
                "print_tts_fail": "TTS 初期化失敗: {e}",
                "print_bili_start": "Bilibili サービスを起動中、ルームID: {id}",
                "print_bili_import": "Bilibili インポート失敗: {e}",
                "print_icon_fail": "アイコン読み込み失敗: {e}"
            },
            // スプラッシュ
            "splash": {
                "dressing_up": "Vivianがおめかし中"
            },
            // WeChat風チャット
            "wechat": {
                "window_title": "{name}とのチャット",
                "name": "びびあん",
                "name_english": "Vivian",
                "status_online": "オンライン",
                ...
                "send": "送信",
                "loading": "読み込み中..",
                "history_header": "— 以上は過去のメッセージ —",
                "no_messages": "まだメッセージはありません、チャットを始めましょう",
                "no_more": "これ以上ありません",
                "load_failed": "読み込み失敗、タップして再試行",
                "avatar_ai": "薇",
                "avatar_user": "私",
                "avatar_unknown": "?",
                "time_yesterday": "昨日",
            ...
            "ai_config": {
                "title": "AI 設定",
                "basic_model_settings": "基本モデル設定",
                "service_provider": "サービスプロバイダー",
                "api_key": "API Key",
                "endpoint": "エンドポイント",
                "model": "モデル",
                "use_legacy_input_format": "豆包API互換形式を使用",
                "use_legacy_input_format_tooltip": "有効にすると豆包APIの入力形式を使用します",
                "temperature": "温度",
                "max_tokens": "最大トークン数",
                "save_config": "設定を保存",
                "api_key_empty": "API Key を入力してください",
                "config_saved": "設定を保存しました",
                "save_failed": "保存失敗: {error}"
            },
            // フラットキー
            "say_something": "何か言いたい..",
            "initialization_complete": "初期化完了",
            "memory_management": "記憶管理",
            "settings": "設定",
            "quit": "終了",
            "memory_core": "記憶コア",
            "memory_index": "記憶インデックス",
            "memory_details": "記憶詳細",
            "short_term_memory": "短期記憶",
            "long_term_memory": "長期記憶",
            "search_memory_content": "記憶を検索",
            "all_importance": "すべての重要度",
            "high_importance": "高重要度",
            "medium_importance": "中重要度",
            "low_importance": "低重要度",
            "delete_memory": "記憶を削除",
            "refresh": "更新",
            "forget_all_memories": "すべての記憶を消去",
            "select_memory_to_view_details": "選択して詳細を表示",
            "total_memories": "合計: {count}",
            "confirm_format": "フォーマット確認",
            "confirm_clear_memories": "すべての記憶を消去しますか？この操作は元に戻せません！",
            "confirm_delete": "削除確認",
            "confirm_delete_memory": "この記憶を削除してもよろしいですか？\n\n{content}",
            "delete_success": "削除成功",
            "delete_failed": "削除失敗: {error}",
            "please_select_memory": "削除する記憶を選択してください",
            "ok": "OK",
            "close_window": "ウィンドウを閉じる",
            "reset_success": "リセット成功",
            "brain_formatted": "記憶をフォーマットしました",
            "error": "エラー",
            "clear_failed": "消去失敗: {error}",
            "memory_id": "記憶ID",
            "memory_type": "記憶タイプ",
            "importance": "重要度",
            ...
            "network_proxy_settings": "ネットワークとプロキシ設定",
            "proxy_mode": "プロキシモード",
            "direct_mode": "プロキシ不使用",
            "system_proxy": "システム設定に従う",
            "custom_proxy": "カスタムプロキシ",
            "proxy_address": "プロキシアドレス",
            "proxy_address_placeholder": "http://127.0.0.1:7890",
            "test_connectivity": "接続テスト",
            "timeout": "タイムアウト",
            "ai_model_providers": "AI モデルプロバイダー",
            "enter_provider_name": "新しいプロバイダー名を入力",
            "add_provider": "プロバイダーを追加",
            "provider_exists": "このプロバイダーは既に存在します",
            "api_address": "API アドレス",
            "api_address_placeholder": "例：https://api.siliconflow.cn/v1",
            "model_name": "モデル名",
            "model_name_placeholder": "例：deepseek-ai/DeepSeek-V3.1",
            "model_identifier": "モデル識別子",
            "ai_routing_matrix": "AI モデルルーティングマトリックス",
            "task_type": "タスクタイプ",
            "primary_model": "優先モデル",
            "fallback_model": "予備モデル",
            "secondary_model": "セカンダリモデル",
            "daily_chat": "日常会話",
            "tool_reasoning": "ツール/推論",
            "smart_diary": "スマート日記",
            "memory_summary": "記憶サマリー",
            "task_memory_extract": "記憶抽出",
            "task_memory_consolidate": "記憶統合",
            "task_graph_entity": "グラフエンティティ抽出",
            "task_graph_community": "グラフコミュニティサマリー",
            "task_query_rewrite": "クエリ書き換え",
            "task_query_hyde": "HyDE 仮想ドキュメント",
            "task_rerank": "再ランク（Cross-Encoder優先）",
            "task_intent_judge": "意図判断",
            "task_pet_command": "デスクトップペットコマンド",
            "none": "なし",
            "select_option": "選択してください",
            "enable_routing_matrix": "スマートルーティングマトリックスを有効にする（オフにするとすべてのリクエストが基本モデル設定を使用）",
            "enable_fallback": "自動フォールバックを有効にする（優先モデルが故障した場合、予備モデルに自動切替）",
            "enter_proxy_address": "プロキシアドレスを入力してください",
            "testing": "テスト中..",
            "test_failed": "テスト失敗",
            "network_connection": "ネットワーク接続",
            "enable_proxy_server": "プロキシサーバーを有効にする",
            "proxy_type": "プロキシタイプ",
            "proxy_host": "プロキシホスト",
            "proxy_port": "プロキシポート",
            "language_settings": "言語設定",
            "diary_settings": "日記設定",
            "enable_auto_diary": "自動日記を有効にする",
            "cancel": "キャンセル",
            "warning": "警告",
            "api_key_empty": "API Key を入力してください",
            "config_saved": "設定を保存しました",
            ...
            "no": "いいえ",
            // ルーティングヘルプ
            "routing_help_title": "モデル用途説明",
            "routing_help_chat": "日常会話、雑談、別れのメッセージなどの軽量インタラクションに使用。\nユーザーが通常のチャットメッセージを送信し、ツール呼び出しが不要な場合にこのモデルを使用します。",
            "routing_help_reasoning": "ツール呼び出し、複雑な推論、コード実行など論理分析が必要なタスクに使用。\nユーザーがアプリの起動、ファイル操作、システムコマンドの実行をリクエストした場合にこのモデルを使用します。",
            "routing_help_diary": "スマート日記生成に使用。\n一日の終わりに、Vivianがこのモデルを呼び出してその日の会話内容を要約し、日記エントリを生成します。",
            "routing_help_memory": "記憶書き込み強化、メモリルーティング仲裁、書き込み検証、ユーザープロファイル抽出などのバックグラウンドタスクに使用。\n以下を含む：\n• 書き込み時LLM強化（description/keywords/importance抽出）\n• AutoExtractorによるADD/UPDATE/DELETE長期記憶\n• メモリルーティング仲裁／書き込み検証／ユーザープロファイル抽出\n• リモート埋め込みサービス（api_key+endpointを再利用）",
            "routing_help_memory_extract": "会話内容から構造化された記憶エントリ（イベント、好み、事実）を抽出。\n要件：厳格なJSON、完全なフィールド、エラーは例外をスローして静かに失敗しない。",
            "routing_help_memory_consolidate": "複数の類似記憶を重複排除/統合/競合解決。\nPhase 6 LightMem オフラインバッチ処理専用、呼び出し頻度は低いが品質要求が高い。",
            "routing_help_graph_entity": "テキストからエンティティ（人名、地名、概念）と関係を抽出。\n知識グラフRAGパスの第一環、構造化出力は厳格であること。",
            "routing_help_graph_community": "知識グラフコミュニティ（関連エンティティのグループ）のサマリーラベルと説明を生成。\n強力な集約能力が必要で、エンティティタイプに敏感でないこと。",
            "routing_help_query_rewrite": "RAG検索前にユーザークエリを書き換え、参照解決とコンテキスト補完を行う。\n短い入力ではレイテンシに敏感。応答の速いモデルを推奨。",
            "routing_help_query_hyde": "HyDE（Hypothetical Document Embeddings）：検索再現率を向上させるための仮想回答を生成。\n高品質な生成とクエリトピックとの強い関連性が必要。",
            "routing_help_rerank": "検索再ランク：Cross-Encoder優先、LLMはバックアップのみ。\nここはNone（cross-encoder使用）を推奨、LLMはCross-Encoderが利用不可の場合のみ有効。",
            "routing_help_intent_judge": "デスクトップペット/フロントエンドの意図判断（雑談/ツール/システム/トリガーアクション）。\n呼び出し頻度高、低レイテンシ要件、厳格なJSON。",
            "routing_help_pet_command": "デスクトップペットの音声/テキストコマンド解析（アプリ起動、操作、インタラクションアクション）。\n構造化出力が必要、エラーは例外をスロー。",
            // 音声認識
            "speech_recognition_settings": "音声認識設定",
            "asr_engine": "認識エンジン",
            "asr_language": "認識言語",
        ...
        translations.insert("ja.diary".to_string(), Value::String("日記".to_string()));
        translations.insert("ja.weekday".to_string(), Value::String("曜日".to_string()));
    }
}
...
mod tests {
    ...
    #[test]
    fn test_global_set_language_ja() {
        set_language("ja");
        assert_eq!(get_language(), "ja");
        assert_eq!(tr("common.ok"), "OK");
        assert_eq!(tr("chat.send"), "送信");
        // 恢复默认
        set_language("zh-CN");
    }
}
