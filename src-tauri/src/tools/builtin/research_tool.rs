...
use crate::tools::types::{
    PermissionResult, Tool, ToolCategory, ToolResult, ToolSemantics, ToolUseContext, ValidationResult,
    ToolRiskTier,
};
...
impl Tool for ObserveUserTool {
    ...
    /// 写入观察记录（非只读），但工具循环收尾时需要角色转述观察结论 → 检索语义
