...
pub use embedding_registry::{
    all_models, lookup as lookup_embedding_model, normalize_dimension, resolve_dimension,
    EmbeddingModelSpec, EmbeddingSource,
};
pub use evidence::{
    apply_evidence_signal, derive_status, evidence_score,
...
pub use lifecycle::{health_score, is_compressible, plan_compression, CompressionPlan, HealthGrade};
...
pub use reranker::{build_reranker, NoopReranker, OllamaRerankClient, Reranker};
pub use retriever::{attach_items, attach_items_with_weights, expand_context, hybrid_search, MemoryRetrievalFilter, RetrievalHit, RetrievalResultType, RetrievalWeights};
pub use strategy::{
...
pub use user_model::{
    CandidateTrait, DetectedEvidence, GoalStatus, ProjectStatus, TraitLifecycle, UserGoal,
    UserModel, UserModelManager, UserProject, UserTrait, UserTraitCategory,
    detect_strong_evidence, detect_weak_evidence,
};
