          ...
          {behaviors.map((entry, idx) => (
            <div
              ...
              style={{
                ...
                borderBottom: idx < behaviors.length - 1 ? `1px solid ${COLORS.subtleBorder}` : '1px solid transparent',
                borderRadius: 6,
              }}
            >
              <div
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: `${SPACING.xs}px 8px`,
                      border: '1px solid transparent',
                      borderBottom: idx < beliefs.length - 1 ? `1px solid ${COLORS.subtleBorder}` : '1px solid transparent',
                      borderRadius: 6,
                    }}
                  >
